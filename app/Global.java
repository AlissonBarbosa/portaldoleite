...
public class Global extends GlobalSettings {
	...
	private void criaDisciplinaTemas(){
		...
		si2.addTema(new Tema("Design"));
		si2.addTema(new Tema("OO"));
		si2.addTema(new Tema("GRASP 1"));
		si2.addTema(new Tema("GoF 1"));
		si2.addTema(new Tema("Arquiteturas"));
		si2.addTema(new Tema("Play Framework"));
		si2.addTema(new Tema("JavaScript Introdução"));
		si2.addTema(new Tema("HTML / CSS / Bootstrap básico"));
		si2.addTema(new Tema("Heroku introdução"));
		si2.addTema(new Tema("Labs"));
		si2.addTema(new Tema("Minitestes"));
		si2.addTema(new Tema("Projeto"));
		dao.persist(si2);
		dao.flush();
	}
}
